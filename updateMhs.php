					...
					?>
						<tr>
							...
							<td>
								...
								<a class="btn btn-outline-danger btn-sm" href="inputKRS.php?kode=<?php echo $row["nim"] ?>">Input KRS</a>
								<a class="btn btn-secondary btn-sm" href="cetakPdf.php?type=krs&nim=<?php echo $row["nim"] ?>&nama=<?php echo $row["nama"] ?>">Cetak KRS</a>
							</td>
						</tr>
				<?php
						$no++;
