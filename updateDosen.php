	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="editDosen.php?kode=<?php 
				echo enkripsiurl($row["npp"])?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="hpsDosen.php?kode=<?php 
				echo enkripsiurl ($row["npp"])?> "onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
